...
class Group(models.Model):
    user = models.ForeignKey(to=UserProfile, on_delete=models.CASCADE, related_name='group_user_id')
...
class Following(models.Model):
    ...
    created_time = models.DateTimeField(auto_now_add=True)
    following = models.ForeignKey(to=UserProfile, on_delete=models.CASCADE, related_name='following_id') # 该用户关注的人的id
